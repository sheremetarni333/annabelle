...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_input":["macro",4],
      "vtp_map":["list",["map","key","10","value","True"],["map","key","25","value","True"],["map","key","50","value","False"],["map","key","75","value","False"],["map","key","90","value","False"]]
    },{
      "function":"__u",
      "vtp_component":"HOST",
  ...
  "tags":[{
      ...
      "vtp_overrideGaSettings":false,
      "vtp_eventCategory":"form on Offer Page",
      ...
      "vtp_nonInteraction":false,
      "vtp_overrideGaSettings":false,
      "vtp_eventCategory":"form on Order Page",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",1],
      "vtp_eventAction":"send",
      "vtp_enableRecaptchaOption":false,
      ...
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",1],
      "vtp_eventAction":["template",["macro",4],"%"],
      ...
      "vtp_measurementId":"G-84GG5JK3ZC",
      ...
      "vtp_fieldsToSet":["list",["map","fieldName","page","value",["macro",10]]],
      "vtp_trackType":"TRACK_PAGEVIEW",
      ...
      "vtp_uniqueTriggerId":"12859470_16",
      "tag_id":74
    },{
      "function":"__fsl",
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"12859470_21",
      "tag_id":75
    },{
      "function":"__sdl",
      ...
      "vtp_uniqueTriggerId":"12859470_27",
      ...
      "vtp_horizontalThresholdOn":false,
      "vtp_uniqueTriggerId":"12859470_28",
      "vtp_enableTriggerStartOption":true,
      "tag_id":77
    },{
      "function":"__fsl",
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"12859470_37",
      "tag_id":78
    },{
      "function":"__hl",
      "tag_id":79
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003E$(document).ready(function(){var a=$('input[name\\x3d\"affid\"]').val();window.dataLayer=window.dataLayer||[];window.dataLayer.push({event:\"pageview\",affid:a})});\u003C\/script\u003E\n  ",
  ...
  "rules":[
    [["if",0],["add",0,3,5,10,17,11,12,13,15,16]],
    [["if",1,2,3],["add",1]],
    [["if",2,4,5],["add",2]],
    [["if",6,7],["add",4]],
    [["if",2,8],["add",6]],
...
var Kd=[C.B,C.J],Ld=function(a){var b=a[C.Pd];b&&D(40);var c=a[C.Qd];c&&D(41);for(var d=Fa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==C.Pd&&f!==C.Qd)if(-1<Ga(Kd,f)){var h=f,k=a[f],l=d[e];vd().set(h,k,l,"RU","RU-SVE",c)}else{}},Md=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
...
Z.g.gaawc=["google"],function(){function a(b,c,d){for(var e=0;e<c.length;e++)b.hasOwnProperty(c[e])&&(b[c[e]]=d(b[c[e]]))}(function(b){Z.__gaawc=b;Z.__gaawc.h="gaawc";Z.__gaawc.i=!0;Z.__gaawc.priorityOverride=10})(function(b){var c=String(b.vtp_measurementId),d=On(b.vtp_fieldsToSet,"name","value")||{};if(d.hasOwnProperty(C.qa)||b.vtp_userProperties){var e=d[C.qa]||{};m(On(b.vtp_userProperties,"name","value"),e);d[C.qa]=e}a(d,C.Ae,function(f){return Sa(f)});a(d,C.Ce,function(f){return Number(f)});
d.send_page_view=b.vtp_sendPageView;ol(d,c);I(b.vtp_gtmOnSuccess)})}();
Z.g.sdl=["google"],function(){function a(){return!!(Object.keys(l("horiz.pix")).length||Object.keys(l("horiz.pct")).length||Object.keys(l("vert.pix")).length||Object.keys(l("vert.pct")).length)}function b(w){for(var y=[],A=w.split(","),B=0;B<A.length;B++){var F=Number(A[B]);if(isNaN(F))return[];q.test(A[B])||y.push(F)}return y}function c(){var w=0,y=0;return function(){var A=Wd(),B=A.height;w=Math.max(v.scrollLeft+A.width,w);y=Math.max(v.scrollTop+B,y);return{Ng:w,Og:y}}}function d(){u=W("self");
t=u.document;v=t.scrollingElement||t.body&&t.body.parentNode;z=c()}function e(w,y,A,B){var F=l(y),E={},J;for(J in F){E.Sa=J;if(F.hasOwnProperty(E.Sa)){var M=Number(E.Sa);w<M||(Zm({event:"gtm.scrollDepth","gtm.scrollThreshold":M,"gtm.scrollUnits":A.toLowerCase(),"gtm.scrollDirection":B,"gtm.triggers":F[E.Sa].join(",")}),zl("sdl",y,function(N){return function(P){delete P[N.Sa];return P}}(E),{}))}E={Sa:E.Sa}}}function f(){var w=z(),y=w.Ng,A=w.Og,B=y/v.scrollWidth*100,F=A/v.scrollHeight*100;e(y,"horiz.pix",
p.hc,r.De);e(B,"horiz.pct",p.fc,r.De);e(A,"vert.pix",p.hc,r.Qe);e(F,"vert.pct",p.fc,r.Qe);yl("sdl","pending",!1)}function h(){var w=250,y=!1;t.scrollingElement&&t.documentElement&&u.addEventListener&&(w=50,y=!0);var A=0,B=!1,F=function(){B?A=Tm(F,w):(A=0,f(),dn("sdl")&&!a()&&(ld(u,"scroll",E),ld(u,"resize",E),yl("sdl","init",!1)));B=!1},E=function(){y&&z();A?B=!0:(A=Tm(F,w),yl("sdl","pending",!0))};return E}function k(w,y,A){if(y){var B=b(String(w));zl("sdl",A,function(F){for(var E=0;E<B.length;E++){var J=
String(B[E]);F.hasOwnProperty(J)||(F[J]=[]);F[J].push(y)}return F},{})}}function l(w){return Al("sdl",w,{})}function n(w){I(w.vtp_gtmOnSuccess);var y=w.vtp_uniqueTriggerId,A=w.vtp_horizontalThresholdsPixels,B=w.vtp_horizontalThresholdsPercent,F=w.vtp_verticalThresholdUnits,E=w.vtp_verticalThresholdsPixels,J=w.vtp_verticalThresholdsPercent;switch(w.vtp_horizontalThresholdUnits){case p.hc:k(A,y,"horiz.pix");break;case p.fc:k(B,y,"horiz.pct")}switch(F){case p.hc:k(E,y,"vert.pix");break;case p.fc:k(J,
y,"vert.pct")}dn("sdl")?Al("sdl","pending")||(x||(d(),x=!0),I(function(){return f()})):(d(),x=!0,v&&(en("sdl"),yl("sdl","pending",!0),I(function(){f();if(a()){var M=h();kd(u,"scroll",M);kd(u,"resize",M)}else yl("sdl","init",!1)})))}var q=/^\s*$/,p={fc:"PERCENT",hc:"PIXELS"},r={Qe:"vertical",De:"horizontal"},u,t,v,x=!1,z;(function(w){Z.__sdl=w;Z.__sdl.h="sdl";Z.__sdl.i=!0;Z.__sdl.priorityOverride=0})(function(w){w.vtp_triggerStartOption?n(w):Il(function(){n(w)})})}();
...
Z.g.hl=["google"],function(){function a(f){return f.target&&f.target.location&&f.target.location.href?f.target.location.href:Vm()}function b(f,h){kd(f,"hashchange",function(k){var l=a(k);h({source:"hashchange",state:null,url:Xm(l),S:Wm(l)})})}function c(f,h){kd(f,"popstate",function(k){var l=a(k);h({source:"popstate",state:k.state,url:Xm(l),S:Wm(l)})})}function d(f,h,k){var l=h.history,n=l[f];if(Ca(n))try{l[f]=function(q,p,r){n.apply(l,[].slice.call(arguments,0));k({source:f,state:q,url:Xm(Vm()),
S:Wm(Vm())})}}catch(q){}}function e(){var f={source:null,state:W("history").state||null,url:Xm(Vm()),S:Wm(Vm())};return function(h){var k=f,l={};l[k.source]=!0;l[h.source]=!0;if(!l.popstate||!l.hashchange||k.S!=h.S){var n={event:"gtm.historyChange","gtm.historyChangeSource":h.source,"gtm.oldUrlFragment":f.S,"gtm.newUrlFragment":h.S,"gtm.oldHistoryState":f.state,"gtm.newHistoryState":h.state,"gtm.oldUrl":f.url,"gtm.newUrl":h.url};f=h;Zm(n)}}}(function(f){Z.__hl=f;Z.__hl.h="hl";Z.__hl.i=!0;Z.__hl.priorityOverride=
0})(function(f){var h=W("self");if(!dn("hl")){var k=e();b(h,k);c(h,k);d("pushState",h,k);d("replaceState",h,k);en("hl")}I(f.vtp_gtmOnSuccess)})}();
